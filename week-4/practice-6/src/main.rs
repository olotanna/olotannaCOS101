fn main() {
    ...
    // About Electrica;/Electronic 
    println!("\nThe {} is not formed by the aspiration to train electrical/electronic engineering professionals in the areas of desugn, building and maintenance of electrical control systems",n4);
